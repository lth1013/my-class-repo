...
export default function Welcome({ loggedIn, setLoggedIn }) {
  ...
  return (
    <div className="d-flex justify-content-center align-items-center mt-4">
      ...
      {/*  ☝️ What is the key piece of ES6 syntax that we use for conditional rendering in React? 🙋 We would create a ternary operator inside the JSX to determine what to render. */}
      {loggedIn ? (
